...
function App() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-300 p-4">
      <div className="w-full max-w-sm h-175 bg-background-light dark:bg-background-dark shadow-2xl rounded-4xl overflow-hidden flex flex-col relative border border-gray-200 dark:border-gray-800 transition-colors duration-300">
        ...
        <main className="flex-1 flex flex-col items-center px-6 pt-2 pb-6 overflow-hidden">
          ...
          <SongInfo
            ...
            artist={songInfo?.artist || "Play YouTube"}
          />
